...
//          mUsrPrompts      =  mPrompts.flatMap( pPrompt => Array( nRunCount ) .fill( pPrompt ) );                   //#.(50410.03.1
//          mUsrPrompts      =  mPrompts.flatMap( pPrompt => Array( nRunCount ).fill().map(() => ( {...pPrompt} ) ) ) //#.(50410.03.1)
