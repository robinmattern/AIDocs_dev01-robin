...
# RUN_COUNT=2
  ...
  node interactive_search_u2.02.mjs  llama3      8000   # Save ./docs/a12_*/25.04.Apr/_t009_Final Test/a12_t009.03.4.50405.1158_Response.txt
  node interactive_search_u2.02.mjs  llama3.2   16000   # Save ./docs/a12_*/25.04.Apr/_t009_Final Test/a12_t009.04.4.50405.1158_Response.txt
